...
public class Playlist implements Serializable {
    ...
    public Playlist isPublic(Boolean isPublic) {
    ...
    public Playlist coverImage(String coverImage) {
    ...
    public Playlist createdAt(Instant createdAt) {
    ...
    public Playlist updatedAt(Instant updatedAt) {
