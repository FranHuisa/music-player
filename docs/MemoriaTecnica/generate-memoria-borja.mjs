  ...
  <section class="chapter">
    ...
    ${table(
      ...
      [
        ...
        [
          'RF-02',
          'El sistema debe permitir registrar usuarios y gestionar la cuenta mediante los mecanismos estándar de JHipster.',
          'Público / usuario',
        ],
        [
          'RF-03',
          'El sistema debe permitir crear, consultar, modificar y eliminar canciones con título, duración, URL de archivo, portada, letra y fecha de lanzamiento.',
          'ADMIN, EDITOR, ARTIST',
        ],
        [
          'RF-04',
          'El sistema debe permitir gestionar álbumes asociados a artistas y clasificados por tipo: álbum, single, EP o serie de podcast.',
          'ADMIN, EDITOR, ARTIST',
        ],
        ...
        [
          'RF-11',
          'El sistema debe ofrecer una barra de reproductor persistente con controles visuales de reproducción, volumen, progreso, repetición y aleatorio.',
          'Todos',
        ],
        [
          'RF-12',
          'El sistema debe permitir reproducir audio mediante el reproductor persistente y consultar letras almacenadas en la información de la canción.',
          'Todos',
        ],
      ],
    )}
    ...
    ${table(
      ...
      [
        [
          'RNF-01',
          'Seguridad',
          'Las rutas de API bajo <code>/api/**</code> requieren autenticación salvo autenticación, registro y recuperación de cuenta.',
        ],
        [
          'RNF-02',
          'Control de acceso',
          'Las rutas de administración requieren <code>ROLE_ADMIN</code> y las vistas de edición de catálogo limitan el acceso a roles autorizados.',
        ],
        [
          'RNF-03',
          'Mantenibilidad',
          'El proyecto mantiene separación entre dominio, repositorio, servicio, DTO, mapper y controlador REST.',
        ],
        ...
        [
          'RNF-07',
          'Observabilidad',
          'El backend incluye Actuator para salud, métricas y configuración, restringiendo endpoints sensibles.',
        ],
    ...
    ${table(
      ...
      [
        [
          ...
          'Iniciar sesión mediante formulario.',
          'El sistema valida credenciales, emite JWT y redirige al dashboard correspondiente.',
        ],
        [
          'CU-02',
          'Administrador',
          'Gestionar usuarios, roles y monitorización.',
          'Se accede a las pantallas de administración y a endpoints protegidos.',
        ],
        [
          'CU-03',
          'Editor o artista',
          'Crear o modificar contenido del catálogo.',
          'La canción, álbum o artista queda persistido y visible en listados.',
        ],
        [
          'CU-04',
          'Usuario final',
          'Crear una playlist y añadir canciones.',
          'La playlist queda asociada al usuario y mantiene el orden de canciones.',
        ],
        ['CU-05', 'Usuario final', 'Marcar canciones como favoritas.', 'Se crea o actualiza una relación Like entre usuario y canción.'],
        [
          'CU-06',
          'Usuario final',
          'Reproducir una canción y consultar su información adicional.',
          'El reproductor solicita el audio al backend y la vista muestra la letra almacenada si existe.',
        ],
      ],
    )}
    ...
    ${table(
      'Tabla 10. Riesgos técnicos y mitigación',
      ['Riesgo', 'Impacto', 'Mitigación aplicada o propuesta'],
      [
        [
          'Gestión local de audio e imágenes',
          'Un fichero malicioso o una ruta manipulada podría comprometer el servidor.',
          'Validación de tipo MIME, normalización de rutas y publicación controlada de <code>uploads</code>.',
        ],
        [
          'Desfase entre documentación y código',
          'La memoria podría prometer funcionalidades no implementadas.',
          'Revisión de JDL, rutas, servicios y componentes antes de redactar la versión final.',
        ],
        [
          'Exposición de operaciones sensibles',
          'Usuarios no autorizados podrían modificar catálogo o usuarios.',
          'JWT, reglas de Spring Security, rutas protegidas y directivas de autoridad en Angular.',
        ],
        [
          'Crecimiento del modelo de datos',
          'Relaciones complejas pueden dificultar consultas y mantenimiento.',
          'DTO, MapStruct, repositorios separados y modelo explicado con diagramas.',
        ],
        [
          'Migraciones inconsistentes',
          'Un entorno podría tener un esquema distinto al esperado.',
          'Uso de Liquibase y changelogs versionados en el repositorio.',
        ],
        [
          'Acoplamiento excesivo frontend-backend',
          'Cambios en entidades podrían romper pantallas.',
          'Comunicación por API REST y modelos TypeScript generados por entidad.',
        ],
      ],
    )}
    ...
    ${table(
      ...
      [
        [
          'Spotify / Apple Music',
          'Catálogo masivo, experiencia de usuario muy pulida y recomendaciones avanzadas.',
          'No son autogestionables y no permiten controlar una instancia propia.',
          'Modelo instalable y adaptable a una organización concreta.',
        ],
        [
          'YouTube Music',
          'Gran variedad de contenido y fuerte integración con el ecosistema Google.',
          'Dependencia total de una plataforma externa y catálogo no controlado por la organización.',
          'Control del catálogo y de la base de usuarios.',
        ],
        [
          'SoundCloud',
          'Facilita la publicación de artistas independientes.',
          'Sistema cerrado y menor control administrativo por parte de una entidad externa.',
          'Roles diferenciados y administración interna.',
        ],
        [
          'Navidrome / Ampache',
          'Servidores musicales de código abierto para bibliotecas propias.',
          'Objetivos distintos y menor integración didáctica con una arquitectura Spring + Angular.',
          'Proyecto académico con API REST, DTO, pruebas y frontend integrado.',
        ],
        [
          'Aplicación desarrollada desde cero',
          'Control completo del código desde el primer archivo.',
          'Mayor tiempo de configuración de seguridad, build, migraciones y pruebas.',
          'JHipster acelera la base técnica y permite centrarse en el dominio musical.',
        ],
      ],
    )}
  ...
  <section class="chapter">
    ...
    ${table(
      ...
      [
        ...
        [
          'Artist',
          'Representa artistas musicales con información descriptiva y estado de verificación.',
          'Uno a muchos con Album y muchos a muchos con Song.',
        ],
        [
          'Album',
          'Agrupa canciones bajo un título, portada, fecha y tipo de publicación.',
          'Muchos a uno con Artist y Genre; uno a muchos con Song.',
        ],
        [
          'Song',
          'Elemento central del catálogo: título, duración, URL de archivo, portada, letra y fecha.',
          'Muchos a uno con Album y Genre; muchos a muchos con Artist; uno a muchos con Play, Like y PlaylistSong.',
        ],
        [
          'Playlist',
          'Lista creada por un usuario con visibilidad pública o privada.',
          'Muchos a uno con User; uno a muchos con PlaylistSong.',
        ],
        [
          'PlaylistSong',
          'Entidad de unión que añade posición y fecha de alta de una canción dentro de una playlist.',
          'Muchos a uno con Playlist y Song.',
        ],
...
&lt;addForeignKeyConstraint
  ...
  referencedColumnNames="id" /&gt;</pre>
    ...
    ${table(
      'Tabla 19. Responsabilidades de clases del dominio y soporte',
      ['Clase o componente', 'Papel técnico', 'Valor dentro del proyecto'],
      [
        [
          'Song',
          'Entidad principal del catálogo musical.',
          'Concentra título, duración, fichero, letra, fecha, estado y relaciones musicales.',
        ],
        [
          'Artist',
          'Entidad asociada a la autoría y gestión musical.',
          'Permite ligar catálogo con identidad de usuario y propiedad del contenido.',
        ],
...
this.audio.src = fileUrl.startsWith('/')
  ...
  this.audio.volume = this.isMuted() ? 0 : this.volume() / 100;
    ...
    ${table(
      'Tabla 20. Migraciones Liquibase clave',
      ['Changelog o grupo', 'Cambio aplicado', 'Justificación técnica'],
      [
        [
          'Creación inicial de entidades',
          'Alta de tablas para género, artista, álbum, canción, playlist, reproducciones y favoritos.',
          'Materializar el modelo musical definido en JDL con integridad referencial.',
        ],
        [
          'Relaciones muchos a muchos',
          'Creación de tablas intermedias como <code>rel_song__artists</code>.',
          'Representar colaboraciones musicales sin duplicar datos en canción o artista.',
        ],
        [
          'Autoridades personalizadas',
          'Inserción de <code>ROLE_EDITOR</code> y <code>ROLE_ARTIST</code>.',
          'Ampliar el esquema base de JHipster para separar consumo y edición de catálogo.',
        ],
        [
          'Ajuste <code>artist_id</code> en canción',
          'Nueva columna y clave foránea desde <code>song</code> hacia <code>artist</code>.',
          'Resolver la propiedad principal de la canción desde backend y simplificar consultas.',
        ],
        [
          'Datos y restricciones auxiliares',
          'Índices, claves ajenas y valores por defecto.',
          'Mantener consistencia y rendimiento mínimo en consultas frecuentes.',
        ],
      ],
    )}
    ...
    ${table(
      'Tabla 21. Correspondencia entre modelo lógico y modelo físico',
      ['Nivel', 'Ejemplo en el proyecto', 'Papel en la solución'],
      [
        [
          'Modelo conceptual',
          'Entidades Song, Album, Artist, Playlist y relaciones musicales.',
          'Expresa necesidades de negocio y sirve de base para el diseño.',
        ],
        [
          'Definición JDL',
          '<code>music.jdl</code> con entidades, campos y relaciones.',
          'Permite generar estructura coherente de backend y frontend.',
        ],
        [
          'Modelo físico',
          'Tablas <code>song</code>, <code>album</code>, <code>artist</code>, <code>playlist_song</code>, etc.',
          'Persistencia real en MySQL con claves foráneas y restricciones.',
        ],
        [
          'Personalización posterior',
          'Changelog que añade <code>artist_id</code> y controladores de subida/streaming.',
          'Adapta la base generada a necesidades específicas de la rama analizada.',
        ],
      ],
    )}
    ...
    ${table(
      ...
      [
        [
          ...
          '2 semanas',
          'Análisis de plataformas musicales, selección de tecnologías y definición del alcance.',
          'Objetivos, requisitos y enfoque técnico.',
        ],
        [
          'Modelado del dominio',
          '1 semana',
          'Diseño JDL, entidades, relaciones y validaciones principales.',
          'Modelo de datos inicial y generación de entidades.',
        ],
        [
          'Backend y seguridad',
          '3 semanas',
          'Configuración JWT, roles, recursos REST, DTO, mappers y migraciones.',
          'API funcional y persistencia reproducible.',
        ],
        [
          'Frontend y experiencia de usuario',
          '3 semanas',
          'Dashboards, listados, formularios, navegación, reproductor visual y letras.',
          'Interfaz navegable por roles.',
        ],
        [
          'Pruebas y correcciones',
          '2 semanas',
          'Pruebas unitarias, integración, validaciones manuales y revisión de errores.',
          'Plan de pruebas y comportamiento validado.',
        ],
        [
          'Documentación final',
          '2 semanas',
          'Redacción de memoria, anexos, diagramas, índices, bibliografía y revisión formal.',
          'Memoria técnica entregable en PDF/Word.',
        ],
      ],
    )}
    ...
    ${table(
      ...
      [
        ...
        [
          'Software base',
          'JDK, Node.js, Spring Boot, Angular, JHipster, MySQL Community, Liquibase y VS Code/IDE comunitario.',
          '0 € en licencias.',
        ],
        ['Infraestructura local', 'Uso de entorno local y Docker para servicios auxiliares.', '0 € en fase de desarrollo.'],
        [
          'Trabajo de análisis y desarrollo',
          'Aproximadamente 13 semanas de trabajo académico parcial.',
          'Coste imputable al esfuerzo formativo.',
        ],
  ...
  <section class="chapter">
    ...
    ${table(
      ...
      [
        [
          ...
          'Servicios, componentes, formularios y utilidades.',
          '116 archivos <code>.spec.ts</code>.',
        ],
        [
          'Integración backend',
          'JUnit 5 + Spring Boot Test',
          'Controladores REST, repositorios, mappers y seguridad.',
          '87 archivos Java de prueba.',
        ],
        [
          'Funcionales manuales',
          'Navegador y Postman',
          'Login, roles, CRUD, playlists, favoritos y letras.',
          'Plan de pruebas documentado.',
        ],
        [
          'Regresión visual',
          'Revisión manual en navegador',
          'Coherencia de dashboards, listados, formularios y reproductor.',
          'Comparación tras cambios de SCSS/HTML.',
        ],
      ],
    )}
    ...
    ${table(
      'Tabla 7. Casos de prueba funcionales',
      ['ID', 'Módulo', 'Pasos resumidos', 'Resultado esperado'],
      [
        [
          'AUTH-01',
          'Autenticación',
          'Entrar en <code>/login</code>, introducir credenciales válidas y enviar.',
          'Se obtiene JWT y se redirige al dashboard según rol.',
        ],
        ...
        [
          'CAT-02',
          'Canciones',
          'Crear canción como editor con campos válidos.',
          'La API devuelve creación correcta y la canción aparece en listado.',
        ],
        ...
        [
          'LYR-01',
          'Letras',
          'Abrir panel de letras con canción seleccionada.',
          'Se muestra letra o mensaje de no disponible sin romper la interfaz.',
        ],
    ...
    ${table(
      'Tabla 22. Evidencias de validación técnica',
      ['Evidencia', 'Qué demuestra', 'Límite de la evidencia'],
      [
        [
          'Pruebas JUnit de recursos y servicios',
          'Que controladores, mappers y repositorios mantienen contratos mínimos esperados.',
          'No sustituyen la validación manual de permisos finos ni de experiencia de usuario.',
        ],
        [
          'Especificaciones Angular',
          'Que servicios, componentes y formularios conservan comportamiento básico.',
          'No cubren por sí solas navegación completa de extremo a extremo.',
        ],
        [
          'Compilación Maven/Angular',
          'Que dependencias, tipado y configuración principal son coherentes.',
          'Compilar no garantiza que todos los flujos de negocio estén bien resueltos.',
        ],
        [
          'Comprobación manual de login, catálogo y reproducción',
          'Que los flujos principales funcionan de manera integrada.',
          'Depende de la disciplina de ejecución y de la cobertura de escenarios elegidos.',
        ],
      ],
    )}
    ...
    ${table(
      'Tabla 13. Resultados por módulo',
      ['Módulo', 'Validación realizada', 'Resultado', 'Riesgo residual'],
      [
        [
          'Autenticación',
          'Login correcto, login incorrecto, persistencia de token y redirección por rol.',
          'Flujo principal correcto.',
          'Revisar expiración y renovación de token en sesiones largas.',
        ],
        [
          'Administración',
          'Acceso a panel, usuarios, autoridades y endpoints de gestión.',
          'Acceso restringido a rol administrador.',
          'Añadir auditoría visible de cambios administrativos.',
        ],
        [
          'Catálogo musical',
          'CRUD de canciones, artistas, álbumes y géneros con validaciones.',
          'Operaciones disponibles para roles autorizados.',
          'Refinar permisos backend por entidad si se separan editor y artista.',
        ],
        [
          'Playlists',
          'Creación de listas y relación ordenada con canciones.',
          'Modelo preparado para ordenar contenido.',
          'Implementar reglas estrictas de propiedad en todas las operaciones.',
        ],
        [
          'Favoritos',
          'Relación Like entre usuario y canción.',
          'Persistencia simple y extensible.',
          'Evitar duplicados con restricción única usuario-canción.',
        ],
        [
          'Reproducciones',
          'Registro de Play asociado a usuario y canción.',
          'Base para historial y estadísticas.',
          'Añadir lógica automática al iniciar reproducción real.',
        ],
        [
          'Audio y reproducción',
          'Construcción de la URL de stream, carga del fichero y actualización del estado del reproductor.',
          'Integración funcional entre frontend y backend.',
          'Añadir control de rangos, métricas y límites de almacenamiento.',
        ],
        [
          'Internacionalización',
          'Existencia de recursos en español e inglés.',
          'Base bilingüe disponible.',
          'Completar traducciones de textos personalizados nuevos.',
        ],
      ],
    )}
...
java -jar target/*.jar</pre>
    ...
    ${table(
      'Tabla 8. Recursos REST principales',
    ...
    ${table(
      ...
      [
        [
          ...
          'Actividad de inicio de sesión y arquitectura cliente-servidor.',
          '<code>AuthenticateController</code>, Spring Security y servicio de login Angular.',
          'AUTH-01, AUTH-02, AUTH-03.',
        ],
        [
          'RF-03 Gestión de canciones',
          'Entidad Song, relaciones con Album, Genre y Artist.',
          '<code>SongResource</code>, <code>SongService</code>, rutas <code>/songs</code>.',
          'CAT-01, CAT-02, CAT-03.',
        ],
        [
          'RF-04 Gestión de álbumes',
          'Entidad Album y enumeración AlbumType.',
          '<code>AlbumResource</code>, formulario Angular de álbum.',
          'Pruebas CRUD de entidad y revisión manual.',
        ],
        [
          'RF-07 Playlists',
          'Entidades Playlist y PlaylistSong.',
          '<code>PlaylistResource</code> y <code>PlaylistSongResource</code>.',
          'PL-01.',
        ],
        ['RF-09 Favoritos', 'Entidad Like vinculada a User y Song.', '<code>LikeResource</code> y vistas de favoritos.', 'LIKE-01.'],
        [
          'RF-10 Dashboards por rol',
          'Casos de uso de administrador, editor/artista y usuario.',
          'Rutas <code>/dashboard-admin</code>, <code>/dashboard-editor</code>, <code>/dashboard-user</code>.',
          'Validación manual de navegación por rol.',
        ],
        [
          'RF-12 Reproducción y letras almacenadas',
          'Reproductor persistente, entidad Song y flujo de streaming.',
          '<code>player.service.ts</code>, <code>FileUploadResource</code> y campo <code>lyrics</code>.',
          'Validación manual de reproducción y consulta de detalle.',
        ],
    ...
    ${table(
      'Tabla 15. Checklist de calidad documental',
    ...
    ${table(
      'Tabla 17. Operaciones de mantenimiento',
      ['Operación', 'Procedimiento recomendado', 'Comprobación posterior'],
      [
        [
          'Añadir un campo a una entidad',
          'Actualizar JDL o entidad, generar/crear changelog Liquibase, ajustar DTO, mapper y formulario Angular.',
          'Compilar backend, revisar formulario y ejecutar pruebas de entidad.',
        ],
        [
          'Cambiar una relación',
          'Analizar cardinalidad, impacto en datos existentes y consultas; crear migración reversible si es posible.',
          'Validar integridad referencial y listados paginados.',
        ],
        [
          'Añadir un rol',
          'Registrar autoridad en datos iniciales o changelog, actualizar constantes backend/frontend y proteger rutas.',
          'Probar login y navegación con usuario que tenga el nuevo rol.',
        ],
        [
          'Modificar textos de interfaz',
          'Actualizar archivos i18n en español e inglés.',
          'Cambiar idioma en la aplicación y revisar que no falten claves.',
        ],
        [
          'Actualizar dependencias frontend',
          'Revisar changelog de Angular/librerías, ejecutar instalación controlada y pruebas.',
          'Ejecutar build y specs afectadas.',
        ],
        [
          'Actualizar Spring/JHipster',
          'Crear rama separada, revisar breaking changes y aplicar migraciones gradualmente.',
          'Compilar, ejecutar pruebas backend y verificar seguridad.',
        ],
        [
          'Preparar despliegue productivo',
          'Externalizar secretos, configurar MySQL, revisar CORS, activar TLS y definir backups.',
          'Prueba de arranque, login, operaciones CRUD y restauración de backup.',
        ],
      ],
    )}
    ...
    ${table(
      'Tabla 18. Revisión de estilo académico',
      ...
      [
        ...
        [
          'Tablas',
          'Título encima, numeración correlativa y contenido sintético.',
          'Las tablas resumen información, no sustituyen la explicación.',
        ],
        ['Código', 'Uso limitado a comandos necesarios en anexos.', 'Se elimina el efecto de documentación automática.'],
        [
          'Bibliografía',
          'Formato APA 7, orden alfabético y fecha de recuperación en documentación viva.',
          'Se cumple la pauta de citación solicitada.',
        ],
        [
          'Anexos',
          'Material complementario: instalación, usuario, REST, glosario, trazabilidad y mantenimiento.',
          'El cuerpo principal conserva coherencia y los detalles quedan separados.',
        ],
      ],
    )}
